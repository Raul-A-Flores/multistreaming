...
export const { selected, saveTwitchSession, saveYoutubeSession, saveLoginSession, twitchChannels, 
    youtubeChannels, selectPlatform, saveSearchResult, selectScreen, selectView
    } = Slice.actions
